...
export function FeedbackSuccessStep({
  ...
  return (
    <>
      ...
      <div className="flex w-[304px] flex-col items-center justify-center py-10">
        <svg
          width="41"
          height="40"
          viewBox="0 0 41 40"
        ...
        <span className="mt-3 mb-3 text-xl">Agradecemos o feedback!</span>
        <button
          onClick={onFeedbackRestartRequested}
          className="flex flex-1 items-center justify-center rounded-md border-transparent bg-zinc-800 p-2 text-sm transition-colors hover:bg-zinc-700 focus:outline-none focus:ring-1 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-zinc-900"
        >
          Quero enviar outro
        </button>
      </div>
